...
def run_sequential(args, logger):
    ...
    scheme = {
        ...
        "nei_mtx": {"vshape": (args.n_agents, args.n_agents)},
        "obs": {"vshape": env_info["obs_shape"], "group": "agents"},
        "actions": {"vshape": (1,), "group": "agents", "dtype": th.long},
        "avail_actions": {"vshape": (env_info["n_actions"],), "group": "agents", "dtype": th.int},
        "action_probs": {"vshape": (env_info["n_actions"],), "group": "agents", "dtype": th.float},
    ...
    runner.run(test_mode=False, render_mode=True, render_ep = 0)
    runner.run(test_mode=True, render_mode=True, render_ep = 1)
